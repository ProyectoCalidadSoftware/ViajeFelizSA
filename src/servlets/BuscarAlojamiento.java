...
public class BuscarAlojamiento extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(request.getParameter("fechaFin"));
		System.out.println(request.getParameter("alojamiento"));
		System.out.println(request.getParameter("habitaciones"));
